  ...
  return (
    <div className="banner-card relative overflow-hidden">
      <div className="relative h-96">
        <Image src="/Heroimage.png" alt="Hero image" layout="fill" objectFit="cover" />
      </div>
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center bg-black bg-opacity-50 text-white p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <Link href="/buy-now">
            <div className="btn-he btn-primary px-6 py-3 rounded-full text-lg md:text-xl lg:text-2xl hover:bg-white hover:text-black transition duration-300">
              Buy Now
            </div>
          </Link>
        </div>
